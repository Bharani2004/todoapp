...
export function TODO(props) {
    ...
    const [newTodoDescription, setNewTodoDescription] = useState(""); // State for description
    ...
    const addTodo = () => {
        const options = {
            ...
            data: {
                title: newTodo,
                description: newTodoDescription, // Include description in data sent to server
            },
        };
        axios
            .request(options)
            .then(function (response) {
                ...
                setNewTodo("");
                setNewTodoDescription(""); // Clear input fields after adding todo
            })
            .catch((error) => {
                console.log(error);
            });
